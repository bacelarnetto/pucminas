...
import br.com.sca.barragem.rabbitmq.producer.BarragemProducer;
import br.com.sca.barragem.rabbitmq.producer.MoradorProducer;
...
public class MonitoramentoService {
	...
	public void processaMonitoramentoBarragem(Monitoramento monitoramento) {
       logger.info("Alterando Status da Barragem. Processo feito via "
       		+ " sensor. ID: " + monitoramento.getIdBarragem());
	...
	public String enviarAlertaManual(EnvioAlertaDTO dto) {
		logger.info("Alterando Status da Barragem para ALTO. Processo"
				+ " feito via TELA. ID: " + dto.getIdBarragem());
